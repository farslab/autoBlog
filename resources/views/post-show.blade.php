...
<body class="font-sans antialiased">
    <main class="flex flex-wrap pt-8 pb-16 lg:pt-16 lg:pb-24 bg-white dark:bg-gray-900 antialiased">
        <div class="md:w-3/5 sm:w-full flex justify-between mx-auto">
            <article
                class="mx-auto px-5 w-full max-w-2xl  format format-sm sm:format-base lg:format-lg format-blue dark:format-invert">
        ...
        <div class="md:w-2/5 sm:w-full">
            <aside aria-label="Son Yazılar" class="flex mx-auto items-center dark:bg-gray-800">
                <div class="px-4 mx-auto ">
                    <h2 class="mb-8 text-2xl font-bold text-gray-900 dark:text-white">Son Yazılar</h2>
                    <div class="grid gap-12 sm:grid-cols-1 lg:grid-cols-1">
                        <article class="max-w-xs">
                            <a href="#">
                                <img src="" class="mb-5 rounded-lg" alt="Image 1">
                            </a>
                        ...
                        <article class="max-w-xs">
                            <a href="#">
                                <img src="" class="mb-5 rounded-lg" alt="Image 2">
                            </a>
                            <h2 class="mb-2 text-xl font-bold leading-tight text-gray-900 dark:text-white">
                        ...
                        <article class="max-w-xs">
                            <a href="#">
                                <img src="" class="mb-5 rounded-lg" alt="Image 3">
                            </a>
                            <h2 class="mb-2 text-xl font-bold leading-tight text-gray-900 dark:text-white">
                        ...
                        <article class="max-w-xs">
                            <a href="#">
                                <img src="" class="mb-5 rounded-lg" alt="Image 4">
                            </a>
                            <h2 class="mb-2 text-xl font-bold leading-tight text-gray-900 dark:text-white">
